...
const SummaryCard = () => {
  return (
    <main className="border rounded-lg divide-y p-5 w-full shadow-lg bg-white">
      <h1 className="p-2 font-bold">Meetings Summary</h1>
      <div className="flex justify-between items-center divide-x-2 space-x-3 p-3">
        <section className="flex items-center space-x-4 p-5 w-full">
          ...
          <div className="space-y-3">
            <p className="text-lg">Previous Meeting</p>
            <p className="text-green-700 text-xl font-bold">+$2,000</p>
            <p className="text-sm text-gray-500">in attendace</p>
          </div>
        </section>
        ...
        <section className="flex items-center space-x-4 p-5 w-full">
          ...
          <div className="space-y-3">
            <p className="text-lg">Current Meeting</p>
        ...
        <section className="flex items-center space-x-4 p-5 w-full">
          ...
          <div className="space-y-3">
            <p className="text-lg">Evangelism</p>
